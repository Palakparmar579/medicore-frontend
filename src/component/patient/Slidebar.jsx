...
import { FaColumns, FaSignOutAlt, FaUser, FaCalendarCheck, FaFileAlt } from "react-icons/fa";
import {NavLink } from "react-router-dom";
const PatientSlidebar = ({ handleLogout, handleProfile }) => {
  return (
    <div
      className="
...
export default PatientSlidebar;